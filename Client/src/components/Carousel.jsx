...
// import "./Carousel.css"; 
// // import { TopHeadlines } from "../APIs/TopHeadlines";
...
//             setArticles(data.slice(0, 5)); // show top 5 articles
//         // };
//         // fetchNews();
//     }, []);
...
//     useEffect(() => {
//         if (articles.length > 0) startAutoSlide();
...
//     if (articles.length === 0) return <p className="text-center p-4">Loading news...</p>;

//     const current = articles[currentIndex];

//     return (
//         <div className="carousel-container" onMouseEnter={stopAutoSlide} onMouseLeave={startAutoSlide}>
...
//                     <a href={current.url} target="_blank" rel="noopener noreferrer" className="text-yellow-300 underline mt-2 inline-block">
//                         Read more
//                     </a>
//                 </div>
//             </div>
...
export const Carousel = () => {
    ...
    useEffect(() => {
        ...
        // };
        setArticles(data.slice(0, 5)); // Use static data
        // fetchNews();
    }, []);
